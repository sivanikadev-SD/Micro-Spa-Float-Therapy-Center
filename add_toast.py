...
dash_file = os.path.join(base_dir, "pages", "dashboard.html")
with open(dash_file, "r", encoding="utf-8") as f:
    dash_content = f.read()

dash_content = dash_content.replace('onclick="showPage(\\'home\\')"', 'onclick="handleLogout()"')

with open(dash_file, "w", encoding="utf-8") as f:
    f.write(dash_content)

print("Toast added successfully")
